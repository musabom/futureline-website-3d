      ...
      <div className="min-h-screen fl-dark-surface bg-[#030d1a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8">
            ...
            <p className="text-slate-400 mt-1">Manage your courses and track your progress</p>
          </div>
          ...
          <div className="mb-10">
            ...
            {enrollments.length === 0 ? (
              <div className="rounded-xl border border-white/[0.07] bg-slate-950/40 backdrop-blur-sm p-12 text-center">
                ...
                <p className="text-slate-500 mb-6">Browse our catalogue to get started</p>
                <Link
                  href="/courses"
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-teal-500 to-blue-600 text-white text-sm font-bold px-6 py-3 rounded-lg hover:opacity-90 transition-opacity"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {enrollments.map((enrollment) => (
                  <Link
                    ...
                    key={enrollment.id}
                    className="rounded-xl border border-white/[0.07] bg-slate-950/40 backdrop-blur-sm overflow-hidden group hover:border-teal-500/30 transition-colors"
                  >
                    <div className="h-32 bg-gradient-to-br from-teal-500/20 to-blue-600/20 flex items-center justify-center border-b border-white/[0.07]">
                      <BookOpen className="text-white/30" size={32} />
                    </div>
                    <div className="p-5">
                      <h3 className="font-bold text-slate-200 mb-2 group-hover:text-teal-400 transition-colors">

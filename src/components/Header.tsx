...
export default function Header() {
  ...
  // '/about' and '/faq' are real routes (no anchor field), not same-page
  // anchors — Vision & Mission and the FAQ moved off the home page.
  const navLinks = [
    { href: '/#services', label: t('whatWeOffer'), anchor: '#services' },

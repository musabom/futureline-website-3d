...
//   lineColor  → teal #18A999 = (0.094, 0.663, 0.600)
//   bgColor1   → surface #031231 = (0.012, 0.071, 0.192)
//   bgColor2   → surface-container-low #0b1a39 = (0.043, 0.102, 0.224)
const fsSource = `
  ...
  const vec4 lineColor = vec4(0.094, 0.663, 0.600, 1.0);
  ...
  void main() {
    ...
    vec4 lines = vec4(0.0);
    vec4 bgColor1 = vec4(0.012, 0.071, 0.192, 1.0);
    vec4 bgColor2 = vec4(0.043, 0.102, 0.224, 1.0);
